package com.example.formacion.dto;
...
public class QHotel extends EntityPathBase<Hotel> {
    ...
    private static final long serialVersionUID = -1172478264L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QHotel hotel = new QHotel("hotel");

    public final QAddress addres;
    ...
    public QHotel(Class<? extends Hotel> type, PathMetadata metadata, PathInits inits) {
        ...
        this.addres = inits.isInitialized("addres") ? new QAddress(forProperty("addres")) : null;
    }
